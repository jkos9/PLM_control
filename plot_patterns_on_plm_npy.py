...
def main() -> None:
    ...
    phase_pattern = np.load("phase_patterns\line_phase_sweep_thick.npy")
    #phase_pattern = np.load("phase_patterns\global_patterns_pi_half_step.npy")


    for i in range(len(phase_pattern)):

        phase = phase_pattern[i]
